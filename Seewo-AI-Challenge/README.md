...
> **"每个学生都被认真对待。"**
>
> **模块化 AI 引擎** · 步骤级批改 · 苏格拉底式辅导 · 拍照即批改 · 批改即分析 · 分析即推送
...
├── 05_技术方案.md             # 技术方案（模块化 AI 引擎·能力模块规格·多步推理链）
...
| 多步推理追踪 | `/teacher/agent-trace/hw_001` | **5 步推理链**透明可追溯（OCR→推理→知识图谱→诊断→策略） |
